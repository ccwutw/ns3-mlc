...
NS_LOG_COMPONENT_DEFINE ("GCLSimV3Drl");
...
main (int argc, char *argv[])
{
    ...
    Ptr<GclGymEnv> myGclGymEnv = CreateObject<GclGymEnv> ();
    myGclGymEnv->SetOpenGymInterface(openGymInterface);
    //Config::SetDefault ("ns3::GclGymEnv::Reward", DoubleValue (1.0)); // Reward when HO success
    //Config::SetDefault ("ns3::GclGymEnv::Penalty", DoubleValue (-1.0)); // Penalty when HO failure
